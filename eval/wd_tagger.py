"""Code from https://huggingface.co/spaces/SmilingWolf/wd-tagger/blob/main/app.py"""
...
def load_labels(dataframe) -> Tuple[List[Any], ...]:
...
class Predictor:
    ...
    def load_model(self, model_repo: str = "SmilingWolf/wd-swinv2-tagger-v3"):
    ...
    def predict(
        ...
        labels = list(zip(self.tag_names, preds[0].astype(float)))  # type: ignore
        ...
        sorted_general_strings = ", ".join(sorted_general_strings).replace("(", r"\(").replace(")", r"\)")  # type: ignore
